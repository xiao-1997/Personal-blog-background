...
export const constantRoutes = [
...

  {
    ...
    children: [{
      path: 'index',
      name: 'Banner',
      component: () => import('@/views/banner/index'),//组件地址
  ...
  {
    path: '/blog',//路径
    component: Layout,//渲染的组件
    redirect: '/blog',
    name: 'Blog',//组件的名称
    meta: { title: '文章管理', icon: 'el-icon-document' },
    children: [//二级子页面
      {
        path: '/blogList',//域名匹配(锚点)
        name: 'BlogList',//与路由相绑定
        component: () => import('@/views/blogList/index'),//组件地址
        meta: { title: '文章列表', icon: 'el-icon-s-order', auth: true }//meta自定义对象
      },
      {
        path: '/blogType',
        name: 'BlogType',
      ...
      },
      {
        path: '/editBlog/:id',
        name: 'editBlog',
        hidden: true,//文档中显示当hidden为true时，不显示在侧边栏
